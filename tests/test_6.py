...
test another deterministic mp

The figure should show a sine for position, and a cosine for velocity
...
for i in range(n):
    covarianceTensor[i,0,i,0] =  0.0


mp1 = promp.ProMP(meansMatrix, covarianceTensor)

mp1.plot(withSampledTrajectories=10, withSupportsMarked=False, withConfidenceInterval=False,withGainsPlots=False)
